...
# --- Configuration ---
# 支持通过环境变量 MCP_LOG_FILE 指定日志文件名
# 如果未设置，默认使用 mcp_io.log
default_log = os.path.join(os.path.dirname(os.path.realpath(__file__)), "mcp_io.log")
LOG_FILE = os.environ.get("MCP_LOG_FILE", default_log)
# --- End Configuration ---
